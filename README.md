...
1. Confirm `/health` returns `ok: true`, `iceMode: "stun-only"`, `visionMode: "face-only"`, `calibrationMode: "neutral-only"`, `pointerInput: "four-buttons"`, `audioMode: "round-synced-real-vocal-with-synthetic-fallback"`, `soundtrackSha256: "8FE25C5D...1D167"`, `roundCueLeadSeconds: 3`, `roundCueAudibleLeadSeconds: 2.45`, `roundVocalMarkerCount: 10`, `turnMode: "fixed-five-round-blocks"`, `roundsPerPointer: 5`, and `totalRounds: 10`.
