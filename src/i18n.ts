const messages = {
  en: {
    ...
    gameover: 'Match complete', youWin: 'YOU WIN!', youLose: 'YOU LOSE', draw: 'DRAW', you: 'You', opponent: 'Opponent', firstTo: '10 rounds · 5 guesses each', cameraEnded: 'The camera stopped. Start again to continue.',
  },
  mn: {
    ...
    gameover: 'Тоглолт дууслаа', youWin: 'ТА ХОЖЛОО!', youLose: 'ТА ХОЖИГДЛОО', draw: 'ТЭНЦЛЭЭ', you: 'Та', opponent: 'Өрсөлдөгч', firstTo: '10 үе · хүн бүр 5 удаа таана', cameraEnded: 'Камер зогслоо. Үргэлжлүүлэхийн тулд дахин асаана уу.',
  },
} as const;
