const messages = {
  en: {
    ...
    hold: 'Hold that position', retryFace: 'Could not see your face — try again', calibrated: 'Ready!', swipeArea: 'Swipe direction control', swipeHint: 'Swipe on WOAH', swipeAccepted: 'Direction locked', swipeTiming: 'Wait for WOAH, then swipe',
  ...
  mn: {
    ...
    hold: 'Энэ байрлалаа бариарай', retryFace: 'Нүүр сайн харагдсангүй — дахин оролдоорой', calibrated: 'Бэлэн!', swipeArea: 'Шудрах чиглэлийн талбар', swipeHint: 'WOAH дээр шудар', swipeAccepted: 'Чиглэл авлаа', swipeTiming: 'WOAH-аа хүлээгээд шудар',
