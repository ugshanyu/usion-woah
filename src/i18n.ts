const messages = {
  en: {
    ...
    share: 'Use the Share button above to invite one friend.', waiting: 'Waiting for your opponent…', opponentReady: 'Opponent is ready', connecting: 'Connecting cameras…', syncing: 'Synchronizing the beat…', reconnecting: 'Reconnecting — the round is paused', networkUnsupported: 'The secure camera connection could not be created. Check your connection, then reopen the game.',
    pointer: 'GUESS', looker: 'DODGE', guessLabel: 'GUESS', faceLabel: 'FACE', yourGuessTurn: 'YOUR TURN TO GUESS', yourDodgeTurn: 'YOUR TURN TO DODGE', preparingTurn: 'CHOOSING THE FIRST TURN', pointerHint: 'Choose one arrow before WOAH. Your first choice is final.', lookerHint: 'Turn your head when 1 appears or within 3 seconds after WOAH. The first recognized direction counts.', judging: 'Recognizing the first face direction…',
    hit: 'CORRECT!', dodge: 'MISSED!', penalty: 'POINT LOST', void: 'REPLAY', hitDetail: 'Correct guess: +1 point. Roles change after five guesses.', dodgeDetail: 'The directions differed, so no point was added. Roles change after five guesses.', penaltyDetail: 'A player did not move before time expired: −1 point. Roles change after five guesses.', voidDetail: 'Network timing or face confidence was not fair enough, so no score changed.',
    gameover: 'Match complete', youWin: 'YOU WIN!', youLose: 'YOU LOSE', draw: 'DRAW', rematch: 'REMATCH', rematchWaiting: 'WAITING FOR OPPONENT…', rematchOpponentReady: 'Opponent wants a rematch', you: 'You', opponent: 'Opponent', firstTo: '10 rounds · 5 guesses each', cameraEnded: 'The camera stopped. Start again to continue.',
  },
  mn: {
    ...
    share: 'Дээрх Share товчоор нэг найзаа урина уу.', waiting: 'Өрсөлдөгчөө хүлээж байна…', opponentReady: 'Өрсөлдөгч бэлэн', connecting: 'Камеруудыг холбож байна…', syncing: 'Цохилтын цагийг тааруулж байна…', reconnecting: 'Дахин холбогдож байна — үеийг түр зогсоолоо', networkUnsupported: 'Камерын аюулгүй холболт үүссэнгүй. Сүлжээгээ шалгаад тоглоомоо дахин нээнэ үү.',
    pointer: 'ТААХ', looker: 'БУЛТАХ', guessLabel: 'ТААЛТ', faceLabel: 'НҮҮР', yourGuessTurn: 'ТАНЫ ТААХ ЭЭЛЖ', yourDodgeTurn: 'ТАНЫ БУЛТАХ ЭЭЛЖ', preparingTurn: 'ЭХНИЙ ЭЭЛЖИЙГ СОНГОЖ БАЙНА', pointerHint: 'WOAH болохоос өмнө нэг сум сонго. Эхний сонголт эцсийнх байна.', lookerHint: '1 гармагц эсвэл WOAH-аас хойш 3 секундын дотор толгойгоо эргүүл. Эхэлж танигдсан чиглэлийг авна.', judging: 'Нүүрний эхний чиглэлийг таньж байна…',
    hit: 'ЗӨВ ТААЛАА!', dodge: 'ТААЖ ЧАДСАНГҮЙ!', penalty: 'ОНОО ХАСАГДЛАА', void: 'ДАХИН', hitDetail: 'Зөв таасан тул +1 оноо авлаа. Таван таалтын дараа дүр солигдоно.', dodgeDetail: 'Чиглэл зөрсөн тул оноо нэмэгдэхгүй. Таван таалтын дараа дүр солигдоно.', penaltyDetail: 'Хугацаанд хөдөлгөөн хийгээгүй тоглогчоос 1 оноо хасна. Таван таалтын дараа дүр солигдоно.', voidDetail: 'Сүлжээний timing эсвэл нүүрний танилт шудар шийдэхэд хангалтгүй тул оноо өөрчлөгдөхгүй.',
    gameover: 'Тоглолт дууслаа', youWin: 'ТА ХОЖЛОО!', youLose: 'ТА ХОЖИГДЛОО', draw: 'ТЭНЦЛЭЭ', rematch: 'ДАХИН ТОГЛОХ', rematchWaiting: 'ӨРСӨЛДӨГЧӨӨ ХҮЛЭЭЖ БАЙНА…', rematchOpponentReady: 'Өрсөлдөгч дахин тоглох хүсэлт илгээлээ', you: 'Та', opponent: 'Өрсөлдөгч', firstTo: '10 үе · хүн бүр 5 удаа таана', cameraEnded: 'Камер зогслоо. Үргэлжлүүлэхийн тулд дахин асаана уу.',
  },
} as const;
