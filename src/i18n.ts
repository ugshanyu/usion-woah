const messages = {
  en: {
    ...
    pointer: 'GUESS', looker: 'DODGE', guessLabel: 'GUESS', faceLabel: 'FACE', yourGuessTurn: 'YOUR TURN TO GUESS', yourDodgeTurn: 'YOUR TURN TO DODGE', preparingTurn: 'CHOOSING THE FIRST TURN', pointerHint: 'Choose one arrow before WOAH. Your first choice is final.', lookerHint: 'Turn your head in any direction exactly on WOAH.', judging: 'Checking the captured moment…',
  ...
  mn: {
    ...
    pointer: 'ТААХ', looker: 'БУЛТАХ', guessLabel: 'ТААЛТ', faceLabel: 'НҮҮР', yourGuessTurn: 'ТАНЫ ТААХ ЭЭЛЖ', yourDodgeTurn: 'ТАНЫ БУЛТАХ ЭЭЛЖ', preparingTurn: 'ЭХНИЙ ЭЭЛЖИЙГ СОНГОЖ БАЙНА', pointerHint: 'WOAH болохоос өмнө нэг сум сонго. Эхний сонголт эцсийнх байна.', lookerHint: 'WOAH дээр толгойгоо аль нэг чиглэл рүү эргүүл.', judging: 'Тухайн агшны хөдөлгөөнийг шалгаж байна…',
