const messages = {
  en: {
    ...
    faceSearching: 'Center your whole face in the frame', faceMoveMore: 'Turn a little farther in the shown direction', faceHold: 'Face detected — hold still', faceRecognized: 'Direction recognized', calibrationRestart: 'Directions were not clear enough — face forward and try again', calibrated: 'Ready!', directionControl: 'Direction buttons', directionHint: 'Press one arrow exactly on WOAH', directionLocked: 'Direction locked', directionTiming: 'Wait for WOAH, then press once', arrowUp: 'Choose up', arrowDown: 'Choose down', arrowLeft: 'Choose left', arrowRight: 'Choose right',
    ...
    pointer: 'GUESS', looker: 'DODGE', yourGuessTurn: 'YOUR TURN TO GUESS', yourDodgeTurn: 'YOUR TURN TO DODGE', preparingTurn: 'CHOOSING THE FIRST TURN', pointerHint: 'Press one of the four arrows exactly on WOAH.', lookerHint: 'Turn your head in any direction exactly on WOAH.', judging: 'Checking the captured moment…',
  ...
  mn: {
    ...
    pointer: 'ТААХ', looker: 'БУЛТАХ', yourGuessTurn: 'ТАНЫ ТААХ ЭЭЛЖ', yourDodgeTurn: 'ТАНЫ БУЛТАХ ЭЭЛЖ', preparingTurn: 'ЭХНИЙ ЭЭЛЖИЙГ СОНГОЖ БАЙНА', pointerHint: 'WOAH дээр дөрвөн сумны нэгийг яг дар.', lookerHint: 'WOAH дээр толгойгоо аль нэг чиглэл рүү эргүүл.', judging: 'Тухайн агшны хөдөлгөөнийг шалгаж байна…',
